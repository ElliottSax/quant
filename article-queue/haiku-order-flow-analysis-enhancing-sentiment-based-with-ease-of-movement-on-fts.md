---
title: '''''''Order Flow Analysis: Enhancing Sentiment-Based with Ease of Movement
  on'
...
Impact on annual return: 17.2% (approximate net of costs)
Impact on Sharpe ratio: 1.91 (adjusted for reduced returns)
...
Order Flow Analysis provides a systematic framework for exploiting microstructure inefficiencies on FTSE 100. The strategy's 2.01 Sharpe ratio and 54.2% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
