---
title: '''''''Order Flow Analysis: Enhancing Overnight Returns with Supertrend on
  EUR/USD'''''''
slug: order-flow-analysis-enhancing-overnight-returns-with-supertrend-on-eurusd
...
Impact on Sharpe ratio: 1.25 (adjusted for reduced returns)
...
Order Flow Analysis provides a systematic framework for exploiting microstructure inefficiencies on EUR/USD. The strategy's 1.32 Sharpe ratio and 58.7% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
