---
title: '''''''Risk Budgeting in Practice: Relative Value Portfolio on Treasury Yield
  Curve'''''''
slug: risk-budgeting-in-practice-relative-value-portfolio-on-treasury-yield-curve
...
Impact on annual return: 21.4% (approximate net of costs)
Impact on Sharpe ratio: 2.21 (adjusted for reduced returns)
...
Risk Budgeting in Practice provides a systematic framework for exploiting microstructure inefficiencies on EUR/USD. The strategy's 2.33 Sharpe ratio and 55.7% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
