---
title: '''''''Regime-Conditional Sizing in Practice: Dispersion Trading Portfolio
  on Bitcoin/Ethereum'''''''
slug: regime-conditional-sizing-in-practice-dispersion-trading-portfolio-on-bitcoineth
...
The strategy was backtested across 500 trades over 7 years of historical data on Bitcoin/Ethereum.

### Performance Metrics

| Metric | Value |
|--------|-------|
| Total Return | 20.5% annual |
| Sharpe Ratio | 0.81 |
...
- Implement wider stops (11.5% of ATR)
...
Impact on annual return: 18.9% (approximate net of costs)
Impact on Sharpe ratio: 0.77 (adjusted for reduced returns)
...
Regime-Conditional Sizing in Practice provides a systematic framework for exploiting microstructure inefficiencies on Bitcoin/Ethereum. The strategy's 0.81 Sharpe ratio and 52.6% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
