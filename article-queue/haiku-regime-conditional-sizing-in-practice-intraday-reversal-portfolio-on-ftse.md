---
title: '''''''Regime-Conditional Sizing in Practice: Intraday Reversal Portfolio on
  FTSE'''
slug: regime-conditional-sizing-in-practice-intraday-reversal-portfolio-on-ftse-100
...
The strategy was backtested across 750 trades over 7 years of historical data on FTSE 100.

### Performance Metrics

| Metric | Value |
|--------|-------|
| Total Return | 8.5% annual |
| Sharpe Ratio | 0.69 |
...
Impact on annual return: 7.8% (approximate net of costs)
Impact on Sharpe ratio: 0.66 (adjusted for reduced returns)
...
A: The order flow window (20 bars) and imbalance threshold (1.5 std) are relatively robust across 750 trades. However, RSI period and confirmation thresholds require asset-specific optimization on rolling 6-month windows.
...
Regime-Conditional Sizing in Practice provides a systematic framework for exploiting microstructure inefficiencies on FTSE 100. The strategy's 0.69 Sharpe ratio and 65.0% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
