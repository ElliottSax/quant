---
title: '''''''Survivorship Bias Testing: Overnight Returns Backtests on VIX Derivatives'''''''
slug: survivorship-bias-testing-overnight-returns-backtests-on-vix-derivatives
...
- **Stop Loss**: 7.1% volatility-adjusted stops
...
- Implement wider stops (11.4% of ATR)
...
Impact on annual return: 10.2% (approximate net of costs)
Impact on Sharpe ratio: 2.36 (adjusted for reduced returns)
...
Survivorship Bias Testing provides a systematic framework for exploiting microstructure inefficiencies on VIX Derivatives. The strategy's 2.48 Sharpe ratio and 54.8% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
