---
title: '''''''Order Flow Analysis: Enhancing Overnight Returns with Market Profile
  on'
slug: order-flow-analysis-enhancing-overnight-returns-with-market-profile-on-ftse-100
...
Impact on annual return: 28.9% (approximate net of costs)
Impact on Sharpe ratio: 2.35 (adjusted for reduced returns)
...
Order Flow Analysis provides a systematic framework for exploiting microstructure inefficiencies on FTSE 100. The strategy's 2.47 Sharpe ratio and 54.1% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
