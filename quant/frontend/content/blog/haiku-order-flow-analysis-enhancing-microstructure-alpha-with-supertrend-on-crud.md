---
title: '''''''Order Flow Analysis: Enhancing Microstructure Alpha with Supertrend
  on Crude'''
...
The strategy was backtested across 250 trades over 7 years of historical data on Crude Oil Futures.

### Performance Metrics

| Metric | Value |
|--------|-------|
| Total Return | 12.2% annual |
| Sharpe Ratio | 1.28 |
...
- Implement wider stops (2.8% of ATR)
...
Impact on annual return: 11.2% (approximate net of costs)
...
Order Flow Analysis provides a systematic framework for exploiting microstructure inefficiencies on Crude Oil Futures. The strategy's 1.28 Sharpe ratio and 51.7% win rate demonstrate consistent outperformance across market regimes. However, successful implementation requires disciplined risk management, realistic slippage assumptions, and quarterly parameter reoptimization.
