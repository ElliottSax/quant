---
title: '''''''Order Flow Analysis: Enhancing Volatility Surface Arbitrage with Force
  Index'''
slug: order-flow-analysis-enhancing-volatility-surface-arbitrage-with-force-index-on-c
...
Impact on Sharpe ratio: 0.72 (adjusted for reduced returns)
