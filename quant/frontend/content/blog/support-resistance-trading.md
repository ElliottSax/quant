...
**Support** forms at price levels where buying demand is strong enough to prevent further decline. Buyers who missed a previous rally enter at the same level, while short sellers cover positions, both contributing to a price floor.

**Resistance** forms at price levels where selling pressure overwhelms buying demand. Traders who bought at higher prices and suffered through a decline sell to break even when price returns, creating a ceiling.
...
This role reversal principle is one of the most consistently reliable phenomena in technical analysis and should be a core component of any support/resistance trading approach.
...
1. Zoom out to a higher timeframe (weekly or monthly) to identify major levels
2. Mark price levels where multiple reversals occurred
3. Use a zone rather than a single line (price rarely reverses at exactly the same level)
4. Prioritize recent levels over older ones (market memory fades)

A support/resistance zone should typically span 0.5-1.5% of the asset price. A stock trading at $100 might have a support zone between $95 and $96.50, not a single line at $95.75.
...
The 200-day SMA is particularly significant. When the S&P 500 pulls back to its 200-day SMA, institutional fund managers often increase equity allocations, creating a self-reinforcing support level. The 50/200-day SMA crossover (golden cross / death cross) is one of the most widely watched signals in institutional trading.
...
**Drawing Rules:**
- Connect swing lows (not candle bodies or arbitrary points)
...
**Setup:**
- Price approaches a previously identified support level (for longs) or resistance level (for shorts)
- A confirmation candle forms at the level (hammer, engulfing, pin bar)
- Volume is present on the reversal candle

**Entry:** Above the high of the confirmation candle (longs) or below the low (shorts)
...
**Entry:** Above the resistance level by a meaningful amount (0.5-1% filter to avoid false breakouts)
**Stop-Loss:** Below the broken resistance level (now expected to act as support)
**Target:** Measured move equal to the depth of the consolidation pattern, or the next resistance level

**False Breakout Filter:** Many breakouts fail. To filter false breakouts:
...
2. Price then pulls back to retest the broken level
3. The broken resistance holds as new support (role reversal)
4. A confirmation candle forms at the retest level

**Entry:** When price confirms the role reversal with a bullish candle at the retested level
**Stop-Loss:** Below the retested level
**Target:** The breakout high (first target) or a measured move projection
...
1. **Number of touches**: More touches = stronger level (3+ is significant)
2. **Volume at the level**: Higher volume = more participants with anchored positions
3. **Recency**: Recent levels are more relevant than older ones
4. **Timeframe**: Levels on higher timeframes are stronger than lower timeframe levels
5. **Confluence**: A horizontal level that aligns with a trendline, Fibonacci level, or moving average is significantly stronger
6. **Rejection violence**: Sharp, fast rejections from a level indicate stronger conviction than gradual turns
