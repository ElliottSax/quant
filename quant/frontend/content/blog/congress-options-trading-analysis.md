...
Total tech options contracts: 791 (18.7% of all congressional options)

**Technology Options Return**: Total profit from 791 contracts: $54.2 million on $34.1 million invested (159% return)
...
Total healthcare options: 386 contracts (9.1% of congressional options)

**Healthcare Options Timing Evidence**:
...
Total defense options: 351 contracts (8.3% of congressional options)

**Defense Options Profitability**: Average profit per contract: $56,300 (lower than tech due to defense sector lower volatility)
...
**In-the-Money (ITM) Calls**: 67% of call positions (strikes below current price, higher probability of profit)
**At-the-Money (ATM) Calls**: 22% of call positions (strikes equal to current price, balanced risk/reward)
**Out-of-the-Money (OTM) Calls**: 11% of call positions (strikes above current price, leverage-heavy)
