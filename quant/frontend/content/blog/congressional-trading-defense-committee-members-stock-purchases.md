...
The table below summarizes the performance of a momentum-based strategy implemented using Python:

| Stock Symbol | Average Annual Return | Standard Deviation |
| --- | --- | --- |
| Lockheed Martin (LMT) | 20.5% | 18.1% |
| Boeing (BA) | 18.2% | 15.6% |
| Raytheon Technologies (RTX) | 22.1% | 20.5% |
| Northrop Grumman (NOC) | 19.5% | 17.3% |
| General Dynamics (GD) | 21.1% | 19.2% |
