...
A comparison of congressional portfolios and the SPY index reveals some interesting findings. The following markdown table illustrates the comparison:
| Metric | Congressional Portfolios | SPY Index |
| --- | --- | --- |
...
Another markdown table that illustrates the comparison of congressional portfolios and the SPY index is:
| Portfolio | Return | Standard Deviation | Sharpe Ratio | Sortino Ratio |
| --- | --- | --- | --- | --- |
